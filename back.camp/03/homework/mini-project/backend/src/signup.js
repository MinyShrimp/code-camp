...
import { getWelcomTemplate, sendTemplateToEmail } from "./email.js";
 ...
 */
const isValidSignupRequestData = async ( body ) => {
 ...
 * @returns Object
 */
const getOpenGraph = async ( prefer ) => {
    const og = {};
